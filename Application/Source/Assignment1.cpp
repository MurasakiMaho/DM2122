...
{	
	...
	meshList[GEO_BLUE_SPHERE] = MeshBuilder::GenerateSphere("blueSphere", Color(0.22353, 0.49412, 0.82745), 10, 20);
	...
	meshList[GEO_GOLD_SPHERE] = MeshBuilder::GenerateSphere("goldSphere", Color(0.65098, 0.54118, 0.21569), 10, 20);
	...
	meshList[GEO_WHITE_HEMISPHERE] = MeshBuilder::GenerateHemisphere("whiteHemisphere", Color(1, 1, 1), 10, 20, 5);
	...
	meshList[GEO_RED_TORUS] = MeshBuilder::GenerateTorus2("redTorus", Color(0.73725, 0.27059, 0.25490), 20, 20, 10, 5);
	...
	meshList[GEO_WHITE_TORUS] = MeshBuilder::GenerateTorus2("whiteTorus", Color(0.89804, 0.89804, 0.89804), 20, 20, 10, 5);
